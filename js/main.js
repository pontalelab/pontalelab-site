...
const i18n = {
  ja: {
    ...
    "game7:name":    "おとのえほん",
    "game7:desc":    "ふりこや笛を配置して、自分だけの音楽を鳴らそう",
    "game7:btn":     "遊ぶ →",
    "game7:age":     "対象年齢の目安：3〜8歳",
    "game8:name":    "おさるのたいこ",
    "game8:desc":    "おさるといっしょにたいこを叩いてリズム遊びを楽しもう",
    "game8:btn":     "遊ぶ →",
    "game8:age":     "対象年齢の目安：2〜6歳",
    "game3:name":    "ポコポコ楽団",
  ...
  en: {
    ...
    "game7:name":    "Oto no Ehon",
    "game7:desc":    "Place pendulums and flutes to make your own music!",
    "game7:btn":     "Play →",
    "game7:age":     "Recommended age: 3–8",
    "game8:name":    "Osaru no Taiko",
    "game8:desc":    "Drum along with the monkey and play with rhythm!",
    "game8:btn":     "Play →",
    "game8:age":     "Recommended age: 2–6",
